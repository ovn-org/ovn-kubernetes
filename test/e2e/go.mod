...
replace (
	...
	k8s.io/kubernetes/test/utils/image => k8s.io/kubernetes/test/utils/image v0.26.1
...
replace go.universe.tf/metallb => github.com/metallb/metallb v0.1.1-0.20230908122239-a5f74ed4c45c
