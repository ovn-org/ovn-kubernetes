...
var _ = ginkgo.Describe("Service Hairpin SNAT", func() { 
	...
	ginkgo.BeforeEach(func() {
		...
		//testPod := e2epod.NewAgnhostPod(f.Namespace.Name, backendName, nil, nil, nil, "netexec", "--http-port=80")
		...
		//testService := clusterIPServiceSpecFrom(svcName, endpointHTTPPort, hairpinPodSel
