...
func GetOvnRegistry() *prometheus.Registry {
	return ovnRegistry
}
...
func RegisterOvnMetrics(registry prometheus.Registerer, clientset kubernetes.Interface, k8sNodeName string) {
	go RegisterOvnDBMetrics(registry, clientset, k8sNodeName)
