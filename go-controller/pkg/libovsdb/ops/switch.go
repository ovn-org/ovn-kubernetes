...
func createOrUpdateLogicalSwitchPortOpModelWithCustomFields(sw *nbdb.LogicalSwitch, lsp *nbdb.LogicalSwitchPort, customFields []ModelUpdateField) operationModel {
...
func createOrUpdateLogicalSwitchPortsOps(nbClient libovsdbclient.Client, ops []libovsdb.Operation, sw *nbdb.LogicalSwitch, createSwitch bool, customFields []ModelUpdateField, lsps ...*nbdb.LogicalSwitchPort) ([]libovsdb.Operation, error) {
	originalPorts := sw.Ports
	sw.Ports = make([]string, 0, len(lsps))
	opModels := make([]operationModel, 0, len(lsps)+1)

	for _, lsp := range lsps {
		opModel := createOrUpdateLogicalSwitchPortOpModelWithCustomFields(sw, lsp, customFields)
...
func createOrUpdateLogicalSwitchPorts(nbClient libovsdbclient.Client, sw *nbdb.LogicalSwitch, createSwitch bool, lsps ...*nbdb.LogicalSwitchPort) error {
	ops, err := createOrUpdateLogicalSwitchPortsOps(nbClient, nil, sw, createSwitch, nil, lsps...)
	if err != nil {
		return err
	}
...
func CreateOrUpdateLogicalSwitchPortsOnSwitchWithCustomFieldsOps(nbClient libovsdbclient.Client, ops []libovsdb.Operation, sw *nbdb.LogicalSwitch, customFields []ModelUpdateField, lsps ...*nbdb.LogicalSwitchPort) ([]libovsdb.Operation, error) {
	return createOrUpdateLogicalSwitchPortsOps(nbClient, ops, sw, false, customFields, lsps...)
}
