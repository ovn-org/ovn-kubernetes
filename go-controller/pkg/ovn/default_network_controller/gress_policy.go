...
func (gp *gressPolicy) buildLocalPodACLs(portGroupName string, aclLogging *bnc.ACLLoggingLevels) []*nbdb.ACL {
...
func (gp *gressPolicy) buildACLAllow(match, l4Match string, ipBlockCIDR int, aclLogging *bnc.ACLLoggingLevels) *nbdb.ACL {
