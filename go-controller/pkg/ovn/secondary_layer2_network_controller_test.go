...
func newSecondaryLayer2NetworkController(cnci *CommonNetworkControllerInfo, netInfo util.NetInfo, nodeName string,
	nadController networkAttachDefController.NADController, eIPController *EgressIPController, portCache *PortCache) *SecondaryLayer2NetworkController {
	layer2NetworkController, _ := NewSecondaryLayer2NetworkController(cnci, netInfo, nadController, eIPController, portCache)
