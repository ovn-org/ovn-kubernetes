...
func NewController(
	...
	klog.V(5).Info("Setting up node informer and lister in Network QoS controller")
...
func (c *Controller) SetNadLister(nadLister nadlister.NetworkAttachmentDefinitionLister) {
	c.nadLister = nadLister
}
