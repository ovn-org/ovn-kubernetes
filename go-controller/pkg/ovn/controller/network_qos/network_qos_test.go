...
var _ = Describe("NetworkQoS Controller", func() {
	...
	var _ = Context("With different interconnect configurations", func() {
		...
		table.DescribeTable("When starting controller with NetworkQoS, Pod and Node objects",
			...
			table.Entry("Interconnect Disabled", false),
			table.Entry("Interconnect Enabled", true),
		)
	})
})
