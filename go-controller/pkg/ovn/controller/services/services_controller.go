...
func NewController(client clientset.Interface,
	...
	klog.Infof("Done creating new service controller for network=%s", netInfo.GetNetworkName())
...
func (c *Controller) queueServiceForEndpointSlice(endpointSlice *discovery.EndpointSlice) {
	serviceName, err := c.getServiceNameFromEndpointSlice(endpointSlice)
	if err != nil {
...
func ServiceControllerKeyForDefaultNetwork(endpointSlice *discovery.EndpointSlice) (string, error) {
	serviceName, err := _getServiceNameFromEndpointSlice(endpointSlice, true) // getServiceNameFromEndpointSlice(endpointSlice)
	if err != nil {
		return "", err
	}
...
func (c *Controller) getServiceNameFromEndpointSlice(endpointSlice *discovery.EndpointSlice) (string, error) {
...
func _getServiceNameFromEndpointSlice(endpointSlice *discovery.EndpointSlice, inDefaultNetwork bool) (string, error) {
	if endpointSlice == nil {
