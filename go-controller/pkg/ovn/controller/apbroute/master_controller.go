...
import (
	...
	adminpolicybasedroutesharedinformer "github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/adminpolicybasedroute/v1/apis/informers/externalversions"
...
type ExternalGatewayMasterController struct {
	...
	routePolicyFactory adminpolicybasedroutesharedinformer.SharedInformerFactory
