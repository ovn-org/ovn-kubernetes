...
func (o *FakeOVN) init(nadList []nettypes.NetworkAttachmentDefinition) {
	...
	if config.OVNKubernetesFeature.EnableMultiNetwork {
		o.networkManager, err = networkmanager.NewForZone("test", "test", &testnm.FakeControllerManager{}, o.watcher)
		gomega.Expect(err).NotTo(gomega.HaveOccurred())
	}
...
func (o *FakeOVN) NewSecondaryNetworkController(netattachdef *nettypes.NetworkAttachmentDefinition) error {
	...
	_ = util.ReconcileNetwork(secondaryController.ReconcilableNetInfo, mutableNetInfo)
	return nil
}
