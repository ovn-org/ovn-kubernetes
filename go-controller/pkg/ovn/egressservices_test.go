...
import (
	...
	egresssvc "github.com/ovn-org/ovn-kubernetes/go-controller/pkg/ovn/controller/egressservice_zone"
	...
	ginkgo.Context("on startup repair", func() {
		...
		ginkgo.It("OVN-IC: should delete stale logical router policies and static routes", func() {
			app.Action = func(ctx *cli.Context) error {
				...
				// invalid next hop - Local node transit switch IP instead of mgmt IP
				staleLRP1 := routerPolicy("staleLRP1-UUID", "testns/svc1", "10.128.1.5", node1transitIPv4)
				// invalid next hop - Remote node mgmt IP instead of transit switch IP
				staleLRP2 := routerPolicy("staleLRP2-UUID", "testns/svc2", "10.128.1.6", "10.128.1.2")
				// remote endpoint configured in local zone
				staleLRP3 := routerPolicy("staleLRP3-UUID", "testns/svc1", "10.128.2.5", node1transitIPv4)
				// Local endpoint to local service
				toKeepLRP1 := routerPolicy("toKeepLRP1-UUID", "testns/svc1", "10.128.1.5", "10.128.1.2")
				// Local endpoint to remote service
				toKeepLRP2 := routerPolicy("toKeepLRP2-UUID", "testns/svc2", "10.128.1.6", node2transitIPv4)

				// Invalid policy
				staleLRSR1 := staticRoute("staleLRSR1-UUID", "testns/svc1", "10.128.2.5", "10.128.1.2")
				staleLRSR1.Policy = &nbdb.LogicalRouterStaticRoutePolicyDstIP
				// egress service doesn't exist
				staleLRSR2 := staticRoute("staleLRSR2-UUID", "testns/svc9000", "10.128.2.5", "10.128.1.2")
				// egress service not in local zone
				staleLRSR3 := staticRoute("staleLRSR3-UUID", "testns/svc2", "10.128.1.5", "10.128.2.2")
				// endpoint is not in the remote zone
				staleLRSR4 := staticRoute("staleLRSR4-UUID", "testns/svc1", "10.128.1.5", "10.128.2.2")
				// invalid next hop - Local node transit switch IP instead of mgmt IP
				staleLRSR5 := staticRoute("staleLRSR5-UUID", "testns/svc1", "10.128.2.5", node1transitIPv4)

				// Valid static route from remote endpoint to local service
				toKeepLRSR1 := staticRoute("toKeepLRSR1-UUID", "testns/svc1", "10.128.2.5", "10.128.1.2")
	...
	ginkgo.Context("on egress service changes", func() {
		...
		ginkgotable.DescribeTable("should create/update/delete OVN configuration", func(interconnectEnabled bool) {
			app.Action = func(ctx *cli.Context) error {
				...
				v4lrp1 := routerPolicy("v4lrp1-UUID", "testns/svc1", "10.128.1.5", "10.128.1.2")
				v4lrp2 := routerPolicy("v4lrp2-UUID", "testns/svc1", "10.128.2.5", "10.128.1.2")
				v6lrp1 := routerPolicy("v6lrp1-UUID", "testns/svc1", "fe00:10:128:1::5", "fe00:10:128:1::2")
				v6lrp2 := routerPolicy("v6lrp2-UUID", "testns/svc1", "fe00:10:128:2::5", "fe00:10:128:1::2")
				v4lrsr := staticRoute("v4lrsr-UUID", "testns/svc1", "10.128.2.5", "10.128.1.2")
				v6lrsr := staticRoute("v6lrsr-UUID", "testns/svc1", "fe00:10:128:2::5", "fe00:10:128:1::2")
				...
				if !interconnectEnabled {
					...
					v4lrp1 = routerPolicy("v4lrp1-UUID", "testns/svc1", "10.128.1.5", node2transitIPv4)
					v6lrp1 = routerPolicy("v6lrp1-UUID", "testns/svc1", "fe00:10:128:1::5", node2transitIPv6)
					clusterRouter.Policies = []string{"v4lrp1-UUID", "v6lrp1-UUID"}
	...
	ginkgo.Context("on endpointslices changes", func() {
		ginkgotable.DescribeTable("should create/update/delete OVN configuration", func(interconnectEnabled bool) {
			app.Action = func(ctx *cli.Context) error {
				...
				v4lrp3 := routerPolicy("v4lrp3-UUID", "testns/svc1", "10.128.1.7", "10.128.1.2")
				if !interconnectEnabled {
	...
	ginkgo.Context("on nodes changes", func() {
		ginkgotable.DescribeTable("should create/update/delete logical router policies and address sets", func(interconnectEnabled bool) {
			app.Action = func(ctx *cli.Context) error {
				...
				svc1v4lrp1 := routerPolicy("svc1v4lrp1-UUID", "testns/svc1", "10.128.2.5", "10.128.1.2")
				svc1v6lrp1 := routerPolicy("svc1v6lrp1-UUID", "testns/svc1", "fe00:10:128:2::5", "fe00:10:128:1::2")
				svc1v4lrsr1 := staticRoute("svc1v4lrsr1-UUID", "testns/svc1", "10.128.2.5", "10.128.1.2")
				svc1v6lrsr1 := staticRoute("svc1v6lrsr1-UUID", "testns/svc1", "fe00:10:128:2::5", "fe00:10:128:1::2")
				...
				svc2v4lrp1 := routerPolicy("svc2v4lrp1-UUID", "testns/svc2", "10.128.1.6", "10.128.2.2")
				svc2v6lrp1 := routerPolicy("svc2v6lrp1-UUID", "testns/svc2", "fe00:10:128:1::6", "fe00:10:128:2::2")
				svc2v4lrp1remote := routerPolicy("svc2v4lrp1remote-UUID", "testns/svc2", "10.128.1.6", node2transitIPv4)
				svc2v6lrp1remote := routerPolicy("svc2v6lrp1remote-UUID", "testns/svc2", "fe00:10:128:1::6", node2transitIPv6)
...
func staticRoute(uuid, key, addr, nexthop string) *nbdb.LogicalRouterStaticRoute {
...
func routerPolicy(uuid, key, addr, nexthop string) *nbdb.LogicalRouterPolicy {
