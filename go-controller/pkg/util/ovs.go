...
func RunOVSOfctl(args ...string) (string, string, error) {
	stdout, stderr, err := GetKexecUtilsInstance(nil).RunCmd(nil, runner.ofctlPath, nil, args...)
...
func RunOVSVsctl(args ...string) (string, string, error) {
	...
	stdout, stderr, err := GetKexecUtilsInstance(nil).RunCmd(nil, runner.vsctlPath, nil, cmdArgs...)
...
func RunOVSAppctlWithTimeout(timeout int, args ...string) (string, string, error) {
	...
	cmdArgs = append(cmdArgs, args...)
	stdout, stderr, err := GetKexecUtilsInstance(nil).RunCmd(nil, runner.appctlPath, nil, cmdArgs...)
	return strings.Trim(strings.TrimSpace(stdout.String()), "\""), stderr.String(), err
}
...
func RunOVNAppctlWithTimeout(timeout int, args ...string) (string, string, error) {
	cmdArgs := []string{fmt.Sprintf("--timeout=%d", timeout)}
	cmdArgs = append(cmdArgs, args...)
	stdout, stderr, err := GetKexecUtilsInstance(nil).RunCmd(nil, runner.ovnappctlPath, nil, cmdArgs...)
	return strings.Trim(strings.TrimSpace(stdout.String()), "\""), stderr.String(), err
}
...
func runOVNretry(cmdPath string, envVars []string, args ...string) (*bytes.Buffer, *bytes.Buffer, error) {
	...
	retriesLeft := 200
	for {
		stdout, stderr, err := GetKexecUtilsInstance(nil).RunCmd(nil, cmdPath, envVars, args...)
		if err == nil {
			return stdout, stderr, err
		}
...
func RunIP(args ...string) (string, string, error) {
	stdout, stderr, err := GetKexecUtilsInstance(nil).RunCmd(nil, runner.ipPath, nil, args...)
...
func RunPowershell(args ...string) (string, string, error) {
	stdout, stderr, err := GetKexecUtilsInstance(nil).RunCmd(nil, runner.powershellPath, nil, args...)
	return strings.TrimSpace(stdout.String()), stderr.String(), err
}

// RunNetsh runs a command via the Windows netsh utility
func RunNetsh(args ...string) (string, string, error) {
	stdout, stderr, err := GetKexecUtilsInstance(nil).RunCmd(nil, runner.netshPath, nil, args...)
	return strings.TrimSpace(stdout.String()), stderr.String(), err
}

// RunRoute runs a command via the Windows route utility
func RunRoute(args ...string) (string, string, error) {
	stdout, stderr, err := GetKexecUtilsInstance(nil).RunCmd(nil, runner.routePath, nil, args...)
	return strings.TrimSpace(stdout.String()), stderr.String(), err
}
...
func RawExec(cmdPath string, args ...string) (string, string, error) {
	...
	stdout, stderr, err := GetKexecUtilsInstance(nil).RunCmd(nil, cmdPath, nil, args...)
	return strings.TrimSpace(stdout.String()), stderr.String(), err
}
...
func AddNormalActionOFFlow(bridgeName string) (string, string, error) {
	...
	cmd.SetStdin(stdin)
	stdout, stderr, err := GetKexecUtilsInstance(nil).RunCmd(cmd, runner.ofctlPath, nil, args...)
	return strings.Trim(stdout.String(), "\" \n"), stderr.String(), err
}
