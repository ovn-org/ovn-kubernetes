...
// ReconcileNetwork reconciles the dynamic network configuration
func ReconcileNetwork(to ReconcilableNetInfo, from NetInfo) error {
	if from == nil || to == nil {
...
func GetNetworkVRFNameForBGP(netInfo NetInfo) string {
...
func GetNetworkVRFNameForDevice(netInfo NetInfo, networkID int) string {
