...
// SetExec provides a mock function with given fields: _a0
func (_m *ExecUtilRunSvc) SetExec(_a0 exec.Interface) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(exec.Interface) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
...
// SetExecWithoutOVS provides a mock function with given fields: _a0
func (_m *ExecUtilRunSvc) SetExecWithoutOVS(_a0 exec.Interface) error {
	ret := _m.Called(_a0)
...
// SetSpecificExec provides a mock function with given fields: _a0, commands
func (_m *ExecUtilRunSvc) SetSpecificExec(_a0 exec.Interface, commands ...string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(exec.Interface, ...string) error); ok {
		r0 = rf(_a0, commands...)
	} else {
		r0 = ret.Error(0)
	}
