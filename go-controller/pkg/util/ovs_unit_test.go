...
func TestRunOVSOfctl(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedErr:             fmt.Errorf("executable file not found in $PATH"),
			onRetArgsExecUtilsIface: &onCallReturnArgs{"Run", []string{"string", "string"}, []interface{}{"", "", fmt.Errorf("executable file not found in $PATH")}},
		},
		{
			desc:                    "positive: run `ovs-ofctl` ",
			expectedErr:             nil,
			onRetArgsExecUtilsIface: &onCallReturnArgs{"Run", []string{"string", "string"}, []interface{}{"", "", nil}},
		},
	}
	for i, tc := range tests {
		t.Run(fmt.Sprintf("%d:%s", i, tc.desc), func(t *testing.T) {
...
func TestRunOVNNbctlUnix(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedErr:             fmt.Errorf("executable file not found in $PATH"),
			onRetArgsExecUtilsIface: &onCallReturnArgs{"RunWithEnvVars", []string{"string", "[]string", "string"}, []interface{}{"", "", fmt.Errorf("executable file not found in $PATH")}},
		},
		{
			desc:                    "positive: run `ovn-nbctl` command with no env vars generated",
			expectedErr:             nil,
			onRetArgsExecUtilsIface: &onCallReturnArgs{"RunWithEnvVars", []string{"string", "[]string", "string"}, []interface{}{"", "", nil}},
		},
	}
	for i, tc := range tests {
		t.Run(fmt.Sprintf("%d:%s", i, tc.desc), func(t *testing.T) {
...
func TestRunOVSDBClientOVNNB(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedErr:             fmt.Errorf("executable file not found in $PATH"),
			onRetArgsExecUtilsIface: &onCallReturnArgs{"RunWithEnvVars", []string{"string", "[]string", "string", "string"}, []interface{}{"", "", fmt.Errorf("executable file not found in $PATH")}},
		},
		{
			desc:                    "positive: run `ovsdb-client` command against OVN NB database",
			expectedErr:             nil,
			onRetArgsExecUtilsIface: &onCallReturnArgs{"RunWithEnvVars", []string{"string", "[]string", "string", "string"}, []interface{}{"", "", nil}},
		},
	}
	for i, tc := range tests {
		t.Run(fmt.Sprintf("%d:%s", i, tc.desc), func(t *testing.T) {
...
func TestAddNormalActionOFFlow(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			desc:                    "negative: run `ovs-ofctl` command",
			expectedErr:             fmt.Errorf("executable file not found in $PATH"),
			onRetArgsExecUtilsIface: &onCallReturnArgs{"RunCmd", []string{"*mocks.Cmd", "string", "[]string", "string", "string", "string", "string", "string"}, []interface{}{"", "", fmt.Errorf("executable file not found in $PATH")}},
...
func TestReplaceOFFlows(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			desc:                    "negative: run `ovs-ofctl` command",
			expectedErr:             fmt.Errorf("executable file not found in $PATH"),
			onRetArgsExecUtilsIface: &onCallReturnArgs{"RunCmd", []string{"*mocks.Cmd", "string", "[]string", "string", "string", "string", "string", "string", "string"}, []interface{}{"", "", fmt.Errorf("executable file not found in $PATH")}},
		...
		},
		{
			desc:                    "positive: run `ovs-ofctl` command",
			expectedErr:             nil,
			onRetArgsExecUtilsIface: &onCallReturnArgs{"RunCmd", []string{"*mocks.Cmd", "string", "[]string", "string", "string", "string", "string", "string", "string"}, []interface{}{"", "", nil}},
			onRetArgsKexecIface:     &onCallReturnArgs{"Command", []string{"string", "string", "string", "string", "string", "string", "string"}, []interface{}{mockCmd}},
			onRetArgsCmdList:        &onCallReturnArgs{"SetStdin", []string{"*bytes.Buffer"}, nil},
		},
	}
...
func TestGetOVNDBServerInfo(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedErr:             true,
			onRetArgsExecUtilsIface: &onCallReturnArgs{"RunWithEnvVars", []string{"string", "[]string", "string", "string", "string", "string"}, []interface{}{"", "", fmt.Errorf("executable file not found in $PATH")}},
		},
		{
			desc:                    "negative: malformed json output",
			expectedErr:             true,
			onRetArgsExecUtilsIface: &onCallReturnArgs{"RunWithEnvVars", []string{"string", "[]string", "string", "string", "string", "string"}, []interface{}{`["rows":[{"connected":true,"index":["set",[]],"leader":true}]}]`, "", nil}},
		},
		{
			desc:                    "negative: zero rows returned",
			expectedErr:             true,
			onRetArgsExecUtilsIface: &onCallReturnArgs{"RunWithEnvVars", []string{"string", "[]string", "string", "string", "string", "string"}, []interface{}{`[{"rows":[]}]`, "", nil}},
		},
		{
...
func TestDetectSCTPSupport(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedErr:             true,
			onRetArgsExecUtilsIface: &onCallReturnArgs{"RunWithEnvVars", []string{"string", "[]string", "string", "string", "string", "string", "string", "string", "string"}, []interface{}{"", "", fmt.Errorf("executable file not found in $PATH")}},
		},
		{
			...
			onRetArgsExecUtilsIface: &onCallReturnArgs{
				...
				[]interface{}{ // below three rows are stdout, stderr and error respectively returned by RunWithEnvVars method
					`"data":"headings":["Column","Type"]}`, //stdout value: mocks malformed json returned
					"",
					nil,
				},
			},
		},
		{
			...
			onRetArgsExecUtilsIface: &onCallReturnArgs{
				...
				[]interface{}{ // below three rows are stdout, stderr and error respectively returned by RunWithEnvVars method
					...
					`{"data":[["protocol",{"key":{"enum":["set",["sctp","tcp","udp"]],"type":"string"},"min":0}]],"headings":["Column","Type"]}`,
					"",
					nil,
				},
			},
		},
		{
			...
			onRetArgsExecUtilsIface: &onCallReturnArgs{
				...
				[]interface{}{ // below three rows are stdout, stderr and error respectively returned by RunWithEnvVars method
					// below is snippet of valid stdout returned and is truncated for unit testing and readability
					`{"data":[["protocol",{"key":{"enum":["set",["tcp","udp"]],"type":"string"},"min":0}]],"headings":["Column","Type"]}`,
					"",
					nil,
				},
			},
