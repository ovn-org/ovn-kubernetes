	...
	}{
		{
			...
			nads: []*nadapi.NetworkAttachmentDefinition{
				ovntest.GenerateNAD("surya", "miguel", "default",
					types.Layer3Topology, "100.128.0.0/16", true),
				ovntest.GenerateNAD("surya", "miguel", "default",
					types.Layer2Topology, "10.100.200.0/24", true),
			},
			expectedErr:           nil,
			namespace:             "default",
		...
		},
		{
			...
			nads: []*nadapi.NetworkAttachmentDefinition{
				...
				ovntest.GenerateNAD("surya", "quique", "ns2",
					types.Layer2Topology, "10.100.200.0/24", false),
			},
			expectedErr:           nil,
			namespace:             "default",
		...
		},
		{
			...
			nads: []*nadapi.NetworkAttachmentDefinition{
				ovntest.GenerateNAD("quique", "miguel", "default",
					types.Layer3Topology, "100.128.0.0/16", false),
				ovntest.GenerateNAD("quique", "miguel", "default",
					types.Layer2Topology, "10.100.200.0/24", false),
			},
			expectedErr:           nil,
