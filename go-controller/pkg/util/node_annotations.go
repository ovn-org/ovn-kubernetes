...
type l3GatewayConfigJSON struct {
	...
	EgressGWInterfaceID string             `json:"egw-interface-id,omitempty"`
	EgressGWMACAddress  string             `json:"egw-mac-address,omitempty"`
	EgressGWIPAddresses []string           `json:"egw-ip-addresses,omitempty"`
	EgressGWIPAddress   string             `json:"egw-ip-address,omitempty"`
