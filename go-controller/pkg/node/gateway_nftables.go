...
// getNoSNATNodePortRules returns rules to prevent SNAT of sourceIP when passing through
// the management port, for an `externalTrafficPolicy: Local` service with NodePorts.
...
// getNoSNATLoadBalancerIPRules returns rules to prevent SNAT of sourceIP when passing
// through the management port, for an `externalTrafficPolicy: Local` service *without*
// NodePorts.
