...
func (npw *nodePortWatcher) AddService(service *kapi.Service) {
	...
	if err != nil {
		...
		hasLocalHostNetworkEp = hasLocalHostNetworkEndpoints(epSlices, &npw.nodeIPManager.addresses)
	}
...
func (npw *nodePortWatcher) AddEndpointSlice(epSlice *discovery.EndpointSlice) {
	...
	hasLocalHostNetworkEp := hasLocalHostNetworkEndpoints([]*discovery.EndpointSlice{epSlice}, &npw.nodeIPManager.addresses)
...
func (npw *nodePortWatcher) UpdateEndpointSlice(oldEpSlice, newEpSlice *discovery.EndpointSlice) {
	...
	hasLocalHostNetworkEpOld := hasLocalHostNetworkEndpoints([]*discovery.EndpointSlice{oldEpSlice}, &npw.nodeIPManager.addresses)
	hasLocalHostNetworkEpNew := hasLocalHostNetworkEndpoints([]*discovery.EndpointSlice{newEpSlice}, &npw.nodeIPManager.addresses)
