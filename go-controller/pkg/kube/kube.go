...
func (k *KubeOVN) UpdateIPAMLeaseIPs(currentIPAMClaim *ipamclaimsapi.IPAMClaim, ips []string) error {
	currentIPAMClaim.Status.IPs = ips
	_, err := k.IPAMClaimsClient.K8sV1alpha1().IPAMClaims(currentIPAMClaim.Namespace).UpdateStatus(context.TODO(), currentIPAMClaim, metav1.UpdateOptions{})
	return err
}
