...
func (_m *Interface) CreateEndpoint(namespace string, ep *v1.Endpoints) (*v1.Endpoints, error) {
...
func (_m *Interface) GetEndpoint(namespace string, name string) (*v1.Endpoints, error) {
	ret := _m.Called(namespace, name)
...
func (_m *Interface) GetNamespaces(labelSelector metav1.LabelSelector) (*v1.NamespaceList, error) {
...
func (_m *Interface) GetNode(name string) (*v1.Node, error) {
	ret := _m.Called(name)
...
func (_m *Interface) GetNodes() (*v1.NodeList, error) {
	ret := _m.Called()
...
func (_m *Interface) GetPods(namespace string, labelSelector metav1.LabelSelector) (*v1.PodList, error) {
...
func (_m *Interface) SetAnnotationsOnNamespace(namespace *v1.Namespace, annotations map[string]string) error {
...
func (_m *Interface) SetAnnotationsOnNode(node *v1.Node, annotations map[string]interface{}) error {
...
func (_m *Interface) SetAnnotationsOnPod(pod *v1.Pod, annotations map[string]string) error {
...
func (_m *Interface) UpdateNodeStatus(node *v1.Node) error {
	ret := _m.Called(node)
