...
// CreateNodeDNSInfo provides a mock function with given fields: nodeDNSInfo
func (_m *KubeInterface) CreateNodeDNSInfo(nodeDNSInfo *nodednsinfov1.NodeDNSInfo) (*nodednsinfov1.NodeDNSInfo, error) {
	ret := _m.Called(nodeDNSInfo)

	var r0 *nodednsinfov1.NodeDNSInfo
	if rf, ok := ret.Get(0).(func(*nodednsinfov1.NodeDNSInfo) *nodednsinfov1.NodeDNSInfo); ok {
		r0 = rf(nodeDNSInfo)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*nodednsinfov1.NodeDNSInfo)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(*nodednsinfov1.NodeDNSInfo) error); ok {
		r1 = rf(nodeDNSInfo)
	} else {
		r1 = ret.Error(1)
	}
...
// DeleteNodeDNSInfo provides a mock function with given fields: name
func (_m *KubeInterface) DeleteNodeDNSInfo(name string) error {
	ret := _m.Called(name)
...
// UpdateNodeDNSInfo provides a mock function with given fields: nodeDNSInfo
func (_m *KubeInterface) UpdateNodeDNSInfo(nodeDNSInfo *nodednsinfov1.NodeDNSInfo) error {
	ret := _m.Called(nodeDNSInfo)

	var r0 error
	if rf, ok := ret.Get(0).(func(*nodednsinfov1.NodeDNSInfo) error); ok {
		r0 = rf(nodeDNSInfo)
	} else {
		r0 = ret.Error(0)
	}
