...
func (_m *ObjectCacheInterface) GetServiceEndpointSlices(namespace string, svcName string) ([]*v1beta1.EndpointSlice, error) {
	ret := _m.Called(namespace, svcName)

	var r0 []*v1beta1.EndpointSlice
	if rf, ok := ret.Get(0).(func(string, string) []*v1beta1.EndpointSlice); ok {
