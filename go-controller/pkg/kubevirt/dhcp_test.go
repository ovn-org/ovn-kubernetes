...
var _ = Describe("Kubevirt", func() {
	type dhcpTest struct {
		...
		dns                               *corev1.Service
		expectedDHCPConfigs               DHCPOption
	...
	DescribeTable("composing dhcp options should success", func(t dhcpTest) {
		...
		Entry("IPv4 Single stack and k8s dns", dhcpTest{
			...
			expectedDHCPConfigs: DHCPOption{V4: ComposeDHCPv4Options("192.168.25.0/24", "192.167.23.44", "defaultController", "namespace1", "foo1")},
		}),
		Entry("IPv6 Single stack and k8s dns", dhcpTest{
			...
			expectedDHCPConfigs: DHCPOption{V6: ComposeDHCPv6Options("2002:0:0:1234::/64", "2001:1:2:3:4:5:6:7", "defaultController", "namespace1", "foo1")},
		}),
		Entry("Dual stack and k8s dns", dhcpTest{
			...
			expectedDHCPConfigs: DHCPOption{
				V4: ComposeDHCPv4Options("192.168.25.0/24", "192.167.23.44", "defaultController", "namespace1", "foo1"),
				V6: ComposeDHCPv6Options("2002:0:0:1234::/64", "2001:1:2:3:4:5:6:7", "defaultController", "namespace1", "foo1"),
			},
		}),
		Entry("Dual stack and k8s dns with ipv4 only", dhcpTest{
			...
			expectedDHCPConfigs: DHCPOption{
				V4: ComposeDHCPv4Options("192.168.25.0/24", "192.167.23.44", "defaultController", "namespace1", "foo1"),
				V6: ComposeDHCPv6Options("2002:0:0:1234::/64", "", "defaultController", "namespace1", "foo1"),
			},
		}),
	)
