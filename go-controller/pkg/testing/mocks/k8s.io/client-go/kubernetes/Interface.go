...
func (_m *Interface) DiscoveryV1alpha1() discoveryv1alpha1.DiscoveryV1alpha1Interface {
	ret := _m.Called()

	var r0 discoveryv1alpha1.DiscoveryV1alpha1Interface
	if rf, ok := ret.Get(0).(func() discoveryv1alpha1.DiscoveryV1alpha1Interface); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(discoveryv1alpha1.DiscoveryV1alpha1Interface)
		}
	}
