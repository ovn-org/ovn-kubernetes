...
import (
	...
	"github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/nodednsinfo/v1/apis/clientset/versioned/scheme"
...
func (c *K8sV1Client) NodeDNSInfos() NodeDNSInfoInterface {
	return newNodeDNSInfos(c)
}
