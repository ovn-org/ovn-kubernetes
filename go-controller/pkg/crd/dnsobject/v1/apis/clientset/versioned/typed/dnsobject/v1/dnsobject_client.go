...
import (
	...
	"github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/dnsobject/v1/apis/clientset/versioned/scheme"
...
func (c *K8sV1Client) DNSObjects() DNSObjectInterface {
	return newDNSObjects(c)
}
