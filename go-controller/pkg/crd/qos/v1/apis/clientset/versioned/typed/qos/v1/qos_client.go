...
import (
	...
	"github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/qos/v1/apis/clientset/versioned/scheme"
...
func (c *K8sV1Client) QoSs(namespace string) QoSInterface {
	return newQoSs(c, namespace)
}
