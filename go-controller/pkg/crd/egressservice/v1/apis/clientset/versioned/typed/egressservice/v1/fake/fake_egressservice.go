...
func (c *FakeEgressServices) Apply(ctx context.Context, egressService *applyconfigurationegressservicev1.EgressServiceApplyConfiguration, opts v1.ApplyOptions) (result *egressservicev1.EgressService, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(egressservicesResource, c.ns, *name, types.ApplyPatchType, data), &egressservicev1.EgressService{})
...
func (c *FakeEgressServices) ApplyStatus(ctx context.Context, egressService *applyconfigurationegressservicev1.EgressServiceApplyConfiguration, opts v1.ApplyOptions) (result *egressservicev1.EgressService, err error) {
	if egressService == nil {
		return nil, fmt.Errorf("egressService provided to Apply must not be nil")
	}
	data, err := json.Marshal(egressService)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(egressservicesResource, c.ns, *name, types.ApplyPatchType, data, "status"), &egressservicev1.EgressService{})
