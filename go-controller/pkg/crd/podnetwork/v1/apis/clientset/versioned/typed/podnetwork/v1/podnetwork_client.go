...
import (
	...
	"github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/podnetwork/v1/apis/clientset/versioned/scheme"
...
func (c *K8sV1Client) PodNetworks(namespace string) PodNetworkInterface {
	return newPodNetworks(c, namespace)
}
