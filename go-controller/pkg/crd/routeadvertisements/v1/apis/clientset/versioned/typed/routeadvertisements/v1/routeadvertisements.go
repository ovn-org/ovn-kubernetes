...
// RouteAdvertisementsesGetter has a method to return a RouteAdvertisementsInterface.
// A group's client should implement this interface.
type RouteAdvertisementsesGetter interface {
	RouteAdvertisementses() RouteAdvertisementsInterface
}
...
// routeAdvertisementses implements RouteAdvertisementsInterface
type routeAdvertisementses struct {
	client rest.Interface
}

// newRouteAdvertisementses returns a RouteAdvertisementses
func newRouteAdvertisementses(c *K8sV1Client) *routeAdvertisementses {
	return &routeAdvertisementses{
		client: c.RESTClient(),
	}
}
...
func (c *routeAdvertisementses) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.RouteAdvertisements, err error) {
	result = &v1.RouteAdvertisements{}
	err = c.client.Get().
		Resource("routeadvertisementses").
		Name(name).
...
func (c *routeAdvertisementses) List(ctx context.Context, opts metav1.ListOptions) (result *v1.RouteAdvertisementsList, err error) {
...
func (c *routeAdvertisementses) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *routeAdvertisementses) Create(ctx context.Context, routeAdvertisements *v1.RouteAdvertisements, opts metav1.CreateOptions) (result *v1.RouteAdvertisements, err error) {
	result = &v1.RouteAdvertisements{}
	err = c.client.Post().
		Resource("routeadvertisementses").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *routeAdvertisementses) Update(ctx context.Context, routeAdvertisements *v1.RouteAdvertisements, opts metav1.UpdateOptions) (result *v1.RouteAdvertisements, err error) {
	result = &v1.RouteAdvertisements{}
	err = c.client.Put().
		Resource("routeadvertisementses").
...
func (c *routeAdvertisementses) UpdateStatus(ctx context.Context, routeAdvertisements *v1.RouteAdvertisements, opts metav1.UpdateOptions) (result *v1.RouteAdvertisements, err error) {
	result = &v1.RouteAdvertisements{}
	err = c.client.Put().
		Resource("routeadvertisementses").
		Name(routeAdvertisements.Name).
...
func (c *routeAdvertisementses) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *routeAdvertisementses) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *routeAdvertisementses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.RouteAdvertisements, err error) {
	result = &v1.RouteAdvertisements{}
...
func (c *routeAdvertisementses) Apply(ctx context.Context, routeAdvertisements *routeadvertisementsv1.RouteAdvertisementsApplyConfiguration, opts metav1.ApplyOptions) (result *v1.RouteAdvertisements, err error) {
...
func (c *routeAdvertisementses) ApplyStatus(ctx context.Context, routeAdvertisements *routeadvertisementsv1.RouteAdvertisementsApplyConfiguration, opts metav1.ApplyOptions) (result *v1.RouteAdvertisements, err error) {
	if routeAdvertisements == nil {
		return nil, fmt.Errorf("routeAdvertisements provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
