...
// BandwidthApplyConfiguration represents an declarative configuration of the Bandwidth type for use
// with apply.
...
// BandwidthApplyConfiguration constructs an declarative configuration of the Bandwidth type for use with
// apply.
