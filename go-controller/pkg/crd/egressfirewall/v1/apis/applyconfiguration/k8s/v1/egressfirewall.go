...
func (b *EgressFirewallApplyConfiguration) WithSelfLink(value string) *EgressFirewallApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	b.SelfLink = &value
	return b
}
...
func (b *EgressFirewallApplyConfiguration) WithOwnerReferences(values ...metav1.OwnerReference) *EgressFirewallApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
