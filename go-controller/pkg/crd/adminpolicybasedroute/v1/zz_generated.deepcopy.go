...
func (in *AdminPolicyBasedExternalRouteSpec) DeepCopyInto(out *AdminPolicyBasedExternalRouteSpec) {
	*out = *in
	if in.Policies != nil {
		...
		*out = make([]*ExternalPolicy, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdminPolicyBasedInternalRoute) DeepCopyInto(out *AdminPolicyBasedInternalRoute) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdminPolicyBasedInternalRoute.
func (in *AdminPolicyBasedInternalRoute) DeepCopy() *AdminPolicyBasedInternalRoute {
	if in == nil {
		return nil
	}
	out := new(AdminPolicyBasedInternalRoute)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *AdminPolicyBasedInternalRoute) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdminPolicyBasedInternalRouteList) DeepCopyInto(out *AdminPolicyBasedInternalRouteList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]AdminPolicyBasedInternalRoute, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdminPolicyBasedInternalRouteList.
func (in *AdminPolicyBasedInternalRouteList) DeepCopy() *AdminPolicyBasedInternalRouteList {
	if in == nil {
		return nil
	}
	out := new(AdminPolicyBasedInternalRouteList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *AdminPolicyBasedInternalRouteList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdminPolicyBasedInternalRouteSpec) DeepCopyInto(out *AdminPolicyBasedInternalRouteSpec) {
	*out = *in
	if in.Policies != nil {
		in, out := &in.Policies, &out.Policies
		*out = make([]*InternalPolicies, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(InternalPolicies)
				**out = **in
			}
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdminPolicyBasedInternalRouteSpec.
func (in *AdminPolicyBasedInternalRouteSpec) DeepCopy() *AdminPolicyBasedInternalRouteSpec {
	if in == nil {
		return nil
	}
	out := new(AdminPolicyBasedInternalRouteSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InternalPolicies) DeepCopyInto(out *InternalPolicies) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InternalPolicies.
func (in *InternalPolicies) DeepCopy() *InternalPolicies {
	if in == nil {
		return nil
	}
	out := new(InternalPolicies)
