...
func (c *FakeK8sV1) AdminPolicyBasedInternalRoutes(namespace string) v1.AdminPolicyBasedInternalRouteInterface {
	return &FakeAdminPolicyBasedInternalRoutes{c, namespace}
}
