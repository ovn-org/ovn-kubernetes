...
import (
	...
	"github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/adminpolicybasedroute/v1/apis/clientset/versioned/scheme"
...
type K8sV1Interface interface {
	...
	AdminPolicyBasedInternalRoutesGetter
}
...
func (c *K8sV1Client) AdminPolicyBasedInternalRoutes(namespace string) AdminPolicyBasedInternalRouteInterface {
	return newAdminPolicyBasedInternalRoutes(c, namespace)
}
