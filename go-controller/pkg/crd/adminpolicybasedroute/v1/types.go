...
// +kubebuilder:resource:path=adminpolicybasedexternalroutes,scope=Cluster,shortName=apbexternalroute,singular=adminpolicyexternalroute
// +kubebuilder:object:root=true
// +kubebuilder:subresource:status
// +kubebuilder:printcolumn:name="Last Update",type="date",JSONPath=`.status.lastTransitionTime`
// +kubebuilder:printcolumn:name="Messages",type="string",JSONPath=`.status.messages`
...
// ExternalNextHops contains slices of StaticHops and DynamicHops structures. Both fields are optional
// to allow administrators the ability to define one or both types of hops in a CR instance.
