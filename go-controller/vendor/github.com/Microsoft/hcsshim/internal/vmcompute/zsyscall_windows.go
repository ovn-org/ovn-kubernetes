...
<<<<<<< HEAD:go-controller/vendor/github.com/Microsoft/hcsshim/internal/vmcompute/zsyscall_windows.go
func _hcsSignalProcess(process HcsProcess, options *uint16, result **uint16) (hr error) {
	if hr = procHcsSignalProcess.Find(); hr != nil {
=======
func _hcsSignalProcess(process hcsProcess, options *uint16, result **uint16) (hr error) {
	if hr = procHcsTerminateProcess.Find(); hr != nil {
>>>>>>> ovnorg/master:go-controller/vendor/github.com/Microsoft/hcsshim/internal/hcs/zsyscall_windows.go
		return
	}
