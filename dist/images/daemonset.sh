...
# ovnkube node for dpu daemonset
ovn_image=${image} \
  ovnkube_compact_mode_enable=${ovnkube_compact_mode_enable} \
  ovn_image_pull_policy=${image_pull_policy} \
  ovn_unprivileged_mode=${ovn_unprivileged_mode} \
  ...
  j2 ../templates/ovnkube-node.yaml.j2 -o ${output_dir}/ovnkube-node-dpu.yaml

# ovnkube node for dpu standalone daemonset. used along with ovnkube-node-dpu-full below
ovn_image=${image} \
  ovnkube_compact_mode_enable=${ovnkube_compact_mode_enable} \
  ovn_image_pull_policy=${image_pull_policy} \
  ovn_unprivileged_mode=${ovn_unprivileged_mode} \
  ...
  ovn_enable_ovnkube_identity=${ovn_enable_ovnkube_identity} \
  ovnkube_app_name=ovnkube-node-dpu \
  j2 ../templates/ovnkube-node.yaml.j2 -o ${output_dir}/ovnkube-node-standalone-dpu.yaml

# ovnkube node for dpu full mode daemonset
ovn_image=${image} \
  ovnkube_compact_mode_enable=${ovnkube_compact_mode_enable} \
  ovn_image_pull_policy=${image_pull_policy} \
  ovn_unprivileged_mode=${ovn_unprivileged_mode} \
  ...
  ovn_v6_masquerade_subnet=${ovn_v6_masquerade_subnet} \
  ovn_enable_ovnkube_identity=${ovn_enable_ovnkube_identity} \
  ovnkube_app_name=ovnkube-node-dpu-full \
  j2 ../templates/ovnkube-node.yaml.j2 -o ${output_dir}/ovnkube-node-dpu-full.yaml
