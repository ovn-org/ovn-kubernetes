...
usage() {
    ...
    echo "-nnpz| --num-nodes-per-zone         If interconnect is enabled, number of nodes per zone (Default 1). If this value > 1, then -wk | --num-workers option and the env var KIND_NUM_WORKER is ignored."
