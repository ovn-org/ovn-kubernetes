...
usage() {
    ...
    echo "-ovr  | --ovn-repo                    Specify the repository to build OVN from DEFAULT: https://github.com/ovn-org/ovn"
    echo "-ovb  | --ovn-branch                  Specify the branch to build OVN from DEFAULT: main"
